Function DJ_Get-AddRemovePrograms
{
	<#
		.SYNOPSIS
		...
		.EXAMPLE
		DJ_Get-AddRemovePrograms -ComputerName 'localhost'
		DJ_Get-AddRemovePrograms -ComputerName 'localhost' -filter '*adobe*'
		DJ_Get-AddRemovePrograms -ComputerName 'Computer1', 'Computer2' -Credentials $cred
		'Computer1', 'Computer2' | DJ_Get-AddRemovePrograms | Out-GridView
